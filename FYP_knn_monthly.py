    ...
    for num in monthly_nums:
        ...
        #X_train, X_test, y_train, y_test = train_test_split(data,target, test_size=0.2, shuffle=False)
            ...
            months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October',
                      'November', 'December']
            month = months[num-1]
            plt.legend(title=month+ ": KNN Monthly Model")
            plt.show()
        ...
        with open(r'C:/Users/morga/Desktop/FINAL YEAR 2019/Project - Research Phase/ProjectData/Results/KNN_monthly/KNN_month_{}_results.txt'.format(month), "w") as f:
            x_i =1
