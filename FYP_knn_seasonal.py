...
def knnr_seasonal():
    ...
    for num in seasonal_nums:
        ...
        target_Series = pd.Series(season_DF['pv'])
        ...
        tscv = model_selection.TimeSeriesSplit(n_splits=num_splits)
        ...
        #X_train, X_test, y_train, y_test = train_test_split(data,target, test_size=0.2, shuffle=False)
            ...
            plt.legend(title=season+": KNN Seasonal Model")

            if season == 'Summer':
                plt.savefig("KNN_seasaon_.png", bbox_inches='tight')
        ...
        with open(r'C:/Users/morga/Desktop/FINAL YEAR 2019/Project - Research Phase/ProjectData/Results/KNN_seasonal/KNN_season_{}_results.txt'.format(season ), "w") as f:
            x_i =1
